var supplyTrend = supplyTrend||{};
var supplyTrendYears = supplyTrendYears||{};
var supplyTrendSelectYear = supplyTrendSelectYear||{};
var supplyTrendSelectYearNonhyun = supplyTrendSelectYearNonhyun||{};
...
supplyTrendSelectYearNonhyun.options = {
...
// 임대료 변동률
supplyTrend.render = function() {
    new ApexCharts(document.querySelector("#supplyTrend"), supplyTrend.options).render();
}
// 공급동향
supplyTrendYears.render = function() {
    new ApexCharts(document.querySelector("#supplyTrendYears"), supplyTrendYears.options).render();
}
// 공급동향 02
supplyTrendSelectYear.render = function() {
    new ApexCharts(document.querySelector("#supplyTrendSelectYear"), supplyTrendSelectYear.options).render();
}
// 상가유형별 평균임대료
supplyTrendSelectYearNonhyun.render = function() {
    new ApexCharts(document.querySelector("#supplyTrendSelectYearNonhyun"), supplyTrendSelectYearNonhyun.options).render();
}
