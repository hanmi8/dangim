...
<div id="0001" style="display:none;">
                        ...
                        <table class="table_type01">
                            ...
                            <tbody>
                                <tr>
                                    <th>납기 내</th>
                                    <td><strong class="won">
                                            <fmt:formatNumber value="${contractInfo.unpaid_amt}" type="number" />
                                        </strong> 원</td>
                                </tr>
                                <tr>
                                    <th>납부 예정일</th>
                                ...
                                <tr>
                                    <th>납기 후</th>
                                    <td><strong class="won" id="after_remain_amt">
                                            <fmt:formatNumber value="${contractInfo.unpaid_arr_amt}" type="number" />
                                        </strong> 원</td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="r_box">
                        ...
                        <table class="table_type02">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th class="">미납금액</th>
                                    <td class="red point_text_style_24"><strong class="result">
                                            <fmt:formatNumber value="${contractInfo.remain_amt}" type="number" /> 원
                                        </strong></td>
                                </tr>
                            </tbody>
                        </table>
        ...
        <div class="section section02">
            ...
            <div class="tb-list01 pc">
                <table id="nonIncomeTable">
                    ...
                    <tbody>
                        <tr>
                            <td colspan="4" style="all: revert; text-align: center !important; border-top: 1px solid #dedede !important; border-bottom: 1px solid #dedede !important; font-weight: normal !important; font-size: 12px; padding: 7px; border-left: none;">납부내역이 존재하지 않습니다.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="if_box">
                ...
                <div class="tb-list01 pc">
                    <table id="incomeTable">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="5" style="all: revert; text-align: center !important; border-top: 1px solid #dedede !important; border-bottom: 1px solid #dedede !important; font-weight: normal !important; font-size: 12px; padding: 7px; border-left: none;"> 납부내역이 존재하지 않습니다. </td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="wideBtn">
	                <button type="button" class="btn" onclick="javascript:income_email_btn();">임대료 납부내역서 <br> 이메일 발송</button>
            	</div>
            </div>
        </div>
    </div>
    ...
    <div id="0006" style="display:none;">
     ...
     <!-- 계약정보 section -->
    <div id="0007" style="dispaly:none;">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="progressbar pc-progressbar" data-cont-st="${contractInfo.date_cont_start}" data-cont-end="${contractInfo.date_cont_end}">
                    ...
                    <table class="table-contract">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="progressbar mb-progressbar" data-cont-st="${contractInfo.date_cont_start}" data-cont-end="${contractInfo.date_cont_end}">
                                        <div class="progress-label" style="top:5px !important">Loading...</div>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
    ...
    <!-- //section -->
     ...
     <!-- 공지사항 section -->
    <div id="0008" style="display:none;">
        <div class="section section06">
            <h3 class="sec_title">공지사항</h3>
            <div class="if_box" id="noticeHNT_iframe">
                <!-- iframe 영역 -->
                <!-- faqList -->
    ...
    <!-- 고객지원 section -->
    <div id="0009" style="display:none;">
        <div class="section section07">
            <h3 class="sec_title">고객지원</h3>

            <div class="tabWrap share_4 if_box">
                <!-- iframe 영역 -->
                <!-- tabBtn -->
                <div class="tabBtn">
...
<!-- 레이어팝업 -->
<div class="layerArea policy policy_incomeEmail">
	<div class="contLy">
		<div class="policyCon">
			<div class="top">
			...
			<p class="title">임대료 납부내역서 이메일 발송</p>
			
			<div class="textCont">	
				<p>
					납부내역 신청 시 매 10분 간격으로 순차적으로 메일이 발송됩니다. 로그인된 아이디의 이메일주소로 전송되오니 이 점 유의해주시기 바랍니다. <br/><br>
				</p>
			</div>
