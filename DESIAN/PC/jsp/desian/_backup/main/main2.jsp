...
<%--				</table>--%>
				...
				<!-- 20201228 코드 수정 -->
				<table id="" class="table-horizontal">
					<colgroup>
						<col width="16.66%">
						<col width="16.66%">
						<col width="16.66%">
					...
					<tr>
						<th>임대료</th>
						<td class="tar">500,000원</td>
						<th>일반관리비</th>
						<td class="tar">12,800원</td>
						<th>런드리룸</th>
						<td class="tar">22,000원</td>
					</tr>
					</tbody>
				</table>
...
<%--				<table id="maintenanceTable_mobile">--%>
<%--					<caption></caption>--%>
<%--					<colgroup>--%>
<%--						<col width="50%">--%>
<%--						<col width="50%">--%>
...
<%--	<article>--%>
<%--		<h5><i class="xi-minus-min"></i> 2020년 11월</h5>--%>
<%--		<div class="tb-list01">--%>
<%--			<table>--%>
<%--				<caption></caption>--%>
<%--				<colgroup>--%>
...
<%--					<td>실비관리비</td>--%>
<%--					<td class="tar">310원</td>--%>
<%--					<td class="tar">21,060원</td>--%>
<%--					<td class="tar">0원</td>--%>
<%--				</tr>--%>
<%--				<tr>--%>
<%--					<td>고정관리비</td>--%>
<%--					<td class="tar">110,000원</td>--%>
<%--					<td class="tar">0원</td>--%>
<%--				</tr>--%>
<%--				<tr>--%>
<%--					<td>서비스</td>--%>
<%--					<td class="tar">3,850원</td>--%>
<%--					<td class="tar">0원</td>--%>
<%--				</tr>--%>
<%--				</tbody>--%>
<%--			</table>--%>
...
<%--	</div>--%>
		...
		<div class="section section03">
			...
			<div class="searchBox">
				<div class="selectBox selType01">
					<select class="selectCus" id="payment_details_date">
						<option value="2019">2019</option>
						<option value="2018">2018</option>
					</select>
				</div>			
				<button type="button" class="btn_type" id="payment_details">납부내역 출력</button>
			</div>
			 -->
			<!-- searchInfo -->
...
<%--						</tbody>--%>
<%--					</table>--%>
						<table id="" class="table-horizontal paidList">
							<caption></caption>
							<colgroup>
								<col width="25%">
								<col width="25%">
				...
				<article>
					<h5><i class="xi-minus-min"></i> 2020년 10월</h5>
					<div class="tb-list01 mobile">
						<table id="" class="table-horizontal paidList">
							<caption></caption>
							<colgroup>
...
<%-- 									<td>${contractInfo.rec_card_comp_code}</td> --%>
	...
	<div class="sub_title_box margin_top_min first">
		...
		<div class="sub_title_box margin_top_min">
			...
			<!-- tb-list01 pc -->
			<h5 class="pc"><i class="xi-minus-min"></i> 테스트빌딩(D.CAMP)  /  1동 F1층 101호</h5>
			<div class="tb-list01 pc">
<%--				<table id="hoTable">--%>
<%--					<caption></caption>--%>
<%--					<colgroup>--%>
...
<%--				</table>--%>
			...
			<article>
			<!-- tb-list01 mobile -->
			<h5><i class="xi-minus-min"></i> 테스트빌딩(D.CAMP)  /  1동 F1층 101호</h5>
			<div class="tb-list01 mobile">
<%--				<table id="hoTable_mobile">--%>
<%--					<caption></caption>--%>
<%--					<colgroup>--%>
<%--						<col width="25%">--%>
<%--						<col width="25%">--%>
